...
public class StationMusicController {
    ...
    public ApiResponse getMusics(@RequestHeader Long memberId, @PathVariable Long stationId,
                                 @RequestParam Long cursor) {

        return ApiResponse.success(SuccessMessage.GET_MUSICS_SUCCESS.getStatus(),
                SuccessMessage.GET_MUSICS_SUCCESS.getMessage(),
                stationMusicService.getMusicByStationIdWithCursor(stationId, cursor));
    }
}
